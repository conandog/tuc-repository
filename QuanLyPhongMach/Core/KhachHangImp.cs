...
namespace Core
{
    public class KhachHangImp : Connection
    {
        ...
        public static int? Insert(User user, string ma, int idGroup, string ten, string gioiTinh,
        ...
        public static bool Update(User user, int id, string ma, int idGroup, string ten, string gioiTinh,
            DateTime? DOB, string CMND = "", string diaChi = "", string dienThoai = "", string email = "", string ghiChu = "")
        {
            bool res = false;
            ...
            try
            {
                ...
                if (data != null)
                {
                    ...
                    data.UpdateBy = data.UpdateBy = user.UserName;
                    data.UpdateDate = data.UpdateDate = DateTime.Now;
