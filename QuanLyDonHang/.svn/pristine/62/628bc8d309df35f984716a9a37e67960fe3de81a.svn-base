...
namespace Controller.Implementation
{
    public class UserImp : SQLConnection
    {
        ...
        public static List<User> GetListByIdGroup(int idUserGroup)
        {
            return dbContext.Users.Where(p => p.IdUserGroup == idUserGroup && p.DeleteFlag == false).ToList();
        }
        ...
        /// <param name="DTDD"></param>
        /// <param name="email"></param>
        /// <param name="ghiChu"></param>
        /// <returns>Return id of the new data if success</returns>
        public static int? Insert(byte idUserGroup, string ten, string userName, string Password, string gioiTinh = "Nam",
