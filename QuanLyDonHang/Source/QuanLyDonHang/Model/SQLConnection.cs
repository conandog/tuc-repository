    ...
    public class SQLConnection
    {
        ...
        public static bool NewConnection()
        {
            try
            {
                ...
                {
                    dbContext = new DatabaseDataContext(String.Format("Data Source={0};Initial Catalog=QuanLyDonHang;Integrated Security=True", ServerName));
                }
                else
                {
                    dbContext = new DatabaseDataContext(String.Format("Data Source={0};Initial Catalog=QuanLyDonHang;User ID={1};Password={2};", ServerName, UserName, Password));
                }
